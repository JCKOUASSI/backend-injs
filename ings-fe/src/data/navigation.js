...
export const PROFESSEUR_MENU = [
  ...
  { path: '/professeur/cours', icon: FiBookOpen, label: 'Mes cours (ECUE)' },
...
export const ETUDIANT_MENU = [
  ...
  { section: 'Formation' },
  { path: '/etudiant/cours', icon: FiBookOpen, label: 'Mes cours (ECUE)' },
  { path: '/etudiant/emploi-du-temps', icon: FiCalendar, label: 'Emploi du temps' },
  { path: '/etudiant/presences', icon: FiCheckSquare, label: 'Présences & badgeage' },
