...
export const ADMIN_MENU = [
  ...
  { path: '/admin/badgeage', icon: FiCheckSquare, label: 'Badgeage QR' },
...
export const PROFESSEUR_MENU = [
  ...
  { path: '/professeur/evaluations', icon: FiCheckSquare, label: 'Évaluations (CC/CT)' },
  { path: '/professeur/presence', icon: FiClock, label: 'Présences' },
...
export const ETUDIANT_MENU = [
  ...
  { path: '/etudiant/badgeage', icon: FiCheckSquare, label: 'Badgeage' },
]
