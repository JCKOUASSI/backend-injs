...
# INVENTAIRE DES COMPTES — photographie chiffrée

- total des comptes : **15**
- comptes actifs : **15**
- comptes inactifs : **0**
- accès admin Django (is_staff) : **4**
- super-utilisateurs : **1**

## Répartition par rôle (champ User.role)
...
- comptes sans last_login (note : non alimenté par le flux JWT, voir écart E11) : **15**
- comptes de secrétariat SANS rattachement (anomalie potentielle) : **0**
- comptes portant plusieurs groupes de rôles : **0**

> Les comptes partagés, doublons d'identité et comptes sans titulaire sont à instruire en U8 ; cette commande les SIGNALE, elle ne les corrige pas.

_Base inspectée : `/home/user/app-injslmd2026demo/backend/db.sqlite3`_
