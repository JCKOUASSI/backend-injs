 ...
 *
 * L'écran ModuleDetail fait 1 900+ lignes et porte de nombreux autres onglets
 * (informations, étudiants, enseignants, éditions, archives, QR) ; ce lot se
 * concentre sur les actions d'écritures liées à l'émargement, testées par
 * l'extérieur sans toucher à la page.
 */
